...
def get_direct_hetero(
    ...
    slab_film = get_ase_surf(
        s=bulk_film_cvn, miller=film_miller, layers=film_layers)
    slab_subs = get_ase_surf(
        s=bulk_subs_cvn, miller=film_subs, layers=bulk_layers)
...
def make_2d_jid_strts(jid1='',jid2='',tol=3.0):
  ...
  rz1=rangexyz(s=mat1)
  rz2=rangexyz(s=mat2)
  x = get_direct_hetero(bulk_film=mat1, bulk_subs=mat2,film_miller=(0, 0, 1),film_subs=(0, 0, 1),film_layers=1,bulk_layers=1,seperation=tol)
  return x
  #return x
