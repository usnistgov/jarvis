...
def test_figshare_download():
    ...
    k = w.list_keys()
    data = data(dataset="megnet")
    pos,neg = data(dataset="stm_2d")
    data = data(dataset="mp_3d")
    data = data(dataset="mp_3d_2020")
    data = data(dataset="qm9")
    data = data(dataset="aflow1")
    data = data(dataset="aflow2")
    data = data(dataset="oqmd_3d")
    data = data(dataset="twod_matpd")
    data = data(dataset="oqmd_3d_no_cfid")
