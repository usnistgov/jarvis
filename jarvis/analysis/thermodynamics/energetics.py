...
if __name__ == "__main__":
     p = Poscar.from_file('/rk2/knc6/JARVIS-DFT/TE-bulk/mp-541837_bulk_PBEBO/MAIN-RELAX-bulk@mp_541837/POSCAR').atoms
     total_energy = -9.974648
     fen = form_enp(atoms=p, total_energy=total_energy)
     print ('fen',fen) 
     x=[{'comp':{'Al':2,'O':1},'energy':-0.15,'id':'xyz'},{'comp':{'Al':2,'O':3},'energy':-16.5,'id':'xyz'},{'comp':{'Al':1,'O':1},'energy':-4.86,'id':'xyz'}]
