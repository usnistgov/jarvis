...
class Vacancy(object):
     def __init__(self,atoms=None,defect_structure=None,  defect_index=None,wyckoff_multiplicity=None, symbol=None):
         self._atoms = atoms
     ...
     def generate_defects(self,supercell_size=[2,2,2],on_conventional_cell = True):
         atoms = self._atoms
         ...
         for i,j in props.items():
                   ...
                   vac = Vacancy(atoms=atoms, defect_structure=defect_strt, defect_index=j, wyckoff_multiplicity=i,symbol=supercell.elements[j])
                   vacs.append(vac)
         return vacs
...
if __name__=='__main__':
    ...
    Si= Poscar.from_file('/rk2/knc6/JARVIS-DFT/2D-bulk/mp-1143_bulk_LDA/MAIN-ELASTIC-bulk@mp_1143/POSCAR').atoms
