...
if __name__ == "__main__":
    ...
    for i in d:
        print(
            ...
            i["jid"],
            "link",
            str("https://www.ctcms.nist.gov/~knc6/jsmol/")
            + str(i["jid"])
            + str(".html"),
        )
        print("Materials project id"), i["mpid"], "link", str(
            "https://www.materialsproject.org/materials/"
        ) + str(i["mpid"])
        ...
        print(
            "static dielectric function in x,optb88vdw", i["epsx"]
        )  # Careful about 2D
