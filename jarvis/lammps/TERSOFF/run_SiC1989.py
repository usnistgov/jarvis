...
###################MAIN PART############################################
for file in glob.glob("SiC_1989.tersoff"):
       ...
       #    print ff,' ',element_ff
        ...
        with MPRester(MAPI_KEY) as m:
             ...
             for d in data:
                 ...
                 parameters = {'job_bin':'/cluster/bin/lmp_ctcms-14439-knc6-2<in.elastic>outt','pair_style':'tersoff','pair_coeff':pair_coeff,'atom_style': 'charge' ,'control_file':'/users/knc6/inelast.mod'}
