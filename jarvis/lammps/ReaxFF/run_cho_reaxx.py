    ...
    try:
        ...
        with MPRester(MAPI_KEY) as m:
            ...
            for d in data:
                ...
                parameters = {
                    "job_bin": "/users/knc6/Software/LAMMPS/lammps-master/src/lmp_serial<in.elastic>outt",
                    "pair_style": "reax/c /users/knc6/lmp_control",
                    "pair_coeff": pair_coeff,
                    "atom_style": "charge",
                    "control_file": "/users/knc6/inelast.mod",
                    "fix": ["2 all qeq/reax 1 0.0 10.0 1e-6 /users/knc6/param.qeq"],
                    "units": "real",
                }
