...
def main(p=None, parameters={}):
    ...
    try:
       ...
       pass
    try:
        surf=pmg_surfer(mat=final_str, min_slab_size=20,vacuum=25,max_index=3)
...
#    print ff,' ',element_ff
        with MPRester(MAPI_KEY) as m:
             ...
             for d in data:
                 ...
                 line=str("from NEW_LAMMPS7 import main_func")+'\n'
