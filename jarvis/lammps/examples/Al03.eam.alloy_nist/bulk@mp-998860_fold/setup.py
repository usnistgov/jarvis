from jarvis.lammps.jlammps import main_func
from pymatgen.io.vasp.inputs import  Poscar
p=Poscar.from_file("/users/knc6/Software/jarvis/jarvis/lammps/examples/Al03.eam.alloy_nist/bulk@mp-998860_fold/POSCAR")
