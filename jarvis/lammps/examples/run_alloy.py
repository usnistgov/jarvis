    ...
    try:
        ...
        with MPRester(MAPI_KEY) as m:
            ...
            for d in data:
                ...
                parameters = {
                    "phonon_control_file": "/users/knc6/in.phonon",
                    "surf_control_file": "/users/knc6/inelast_nobox.mod",
                    "def_control_file": "/users/knc6/inelast_nobox.mod",
                    "json_dat": "/rk2/knc6/JARVIS-DFT/MDCS/all_mp.json",
                    "c_size": 3,
                    "vac_size": 25,
                    "surf_size": 25,
                    "phon_size": 20,
                    "cluster": "sbatch",
                    "exec": "/users/knc6/Software/LAMMPS/lammps-master/src/lmp_serial <in.main >out",
