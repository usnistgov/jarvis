...
for id in jidlist:
        ...
        line=str("prepare_wien_input(jid=")+str("'")+str(id)+str("'")+str(")")+'\n'
...
##        line=str("#SBATCH --mem=")+str(mem)+'\n'
        ...
        f.write(line)
        line=str("module load intel/2013_sp1.2.144 mkl/11.1.2.144 mvapich2_ib/2.1 fftw/3.3.8   ")+'\n'
        ...
        f.write(line)
        line=str('/home/smandal/miniconda2/envs/my_jarvis/bin/python ')+str(cwd)+str('/')+str(id)+str('/dmft.py>out')+'\n'
        f.write(line)
        f.close()
