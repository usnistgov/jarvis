...
class WriteInputs(object):
      ...
      def __init__(self,vasprun_path='',dos_type ='HISTO',  tmax=1300,tgrid=50,doping=[], run_type='BOLTZ',symprec=1e-2,energy_grid=0.005, lpfac=10, energy_span_around_fermi=1.5, energy=None, struct=None, intrans=None):
