...
class BoltzTrapOutput(object):
    def __init__(self,path='',outtrans_data=[],intrans_data=[],condtens_fixdoping=[], halltens_fixdoping=[]):
    ...
    def to_dict(self):
          ...
          d['halltesn_fixdoping']=self.read_halltens_fixdoping() #self.halltesn_fixdoping
          d['condtens_fixdoping']=self.read_condtens_fixdoping() #self.condtens_fixdoping
          return d
...
if __name__ == "__main__":
   ...
   b= BoltzTrapOutput(path='/rk2/knc6/JARVIS-DFT/Elements-bulkk/mp-149_bulk_PBEBO/MAIN-RELAX-bulk@mp-149/boltztrap').read_condtens_fixdoping()
   b= BoltzTrapOutput(path='/rk2/knc6/JARVIS-DFT/Elements-bulkk/mp-149_bulk_PBEBO/MAIN-RELAX-bulk@mp-149/boltztrap').read_outputtrans()
   b= BoltzTrapOutput(path='/rk2/knc6/JARVIS-DFT/Elements-bulkk/mp-149_bulk_PBEBO/MAIN-RELAX-bulk@mp-149/boltztrap').to_dict()
   print (b) 
