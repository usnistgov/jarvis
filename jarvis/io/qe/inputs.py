...
class QEinfile(object):
    ...
    def __init__(self, atoms, kpoints, psp_dir=None, input_params={}):
        ...
        # update based on atoms, kpoints
        input_params["control_params"]["nat"] = atoms.num_atoms
        self.species = atoms.uniq_species
        input_params["control_params"]["ntyp"] = len(self.species)
