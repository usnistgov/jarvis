...
"""
parameters={'exec':'mpirun /cluster/bin/lmp_ctcms-14439-knc6 <in.elastic >out','pair_coeff': '/users/knc6/Software/jarvis/jarvis/lammps/examples/Mishin-Ni-Al-2009.eam.alloy', 'control_file': '/users/knc6/inelast.mod', 'pair_style': 'eam/alloy', 'atom_style': 'charge','cluster':'pbs'}
write_lammps_in(structure=p,lammps_in="init.mod",lammps_in1="potential.mod",lammps_in2="in.elastic", parameters = parameters)
