...
setup(
    name="jarvis-tools",
    version="2018.10.23",
    install_requires=["custodian>=1.0.4","ase==3.16.2","pymatgen==2017.8.4","sphinx==1.8.1","pybtex==0.21","phonopy==1.10.8","fortranformat==0.2.5","pandas==0.23.4","scikit-learn==0.18.1","lightgbm==2.1.0"],
